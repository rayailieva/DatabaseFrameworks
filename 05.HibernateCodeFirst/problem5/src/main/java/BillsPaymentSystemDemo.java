...
public class BillsPaymentSystemDemo {
    public static void main(String[] args) {
        ...
        user1.setBillingDetails(new LinkedList<>());
        ...
        user2.setBillingDetails(new LinkedList<>());
        ...
        creditCard1.setExpirationYear((byte) 2011);
        ...
        creditCard2.setExpirationYear((byte) 2022);
