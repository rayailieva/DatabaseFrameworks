...
public class AppController implements CommandLineRunner {
    ...
    public AppController(AnimalAidService animalAidService, AnimalService animalService, VetService vetService, ProcedureService procedureService, FileIOUtil fileIOUtil, Gson gson, XmlParser xmlParser) {
    ...
    private void importAnimalAids() throws IOException {
        ...
        this.animalAidService.importAnimalAid(animalAidImportDtos);
    }
